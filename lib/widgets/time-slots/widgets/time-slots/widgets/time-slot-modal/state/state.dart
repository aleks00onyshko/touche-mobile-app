...
enum TimeSlotModalStateKeys { loading, teachers, booked, duration, selectedTeacher, attendeeId, showBookButton }
...
interface class TimeSlotModalState implements ChangeNotifierState {
  ...
  late int duration = 0;
  late bool showBookButton = false;
  String? attendeeId;
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      TimeSlotModalStateKeys.showBookButton.name: showBookButton
    };
  }
}
